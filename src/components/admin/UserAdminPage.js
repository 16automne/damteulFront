...
/* -------------------------------------------------
   📌 샘플 사용자 데이터
   - grade  : 커뮤니티 등급
   - status : 계정 상태 (활동중 / 정지 / 탈퇴)
------------------------------------------------- */
const sampleUsers = [
  // ===== 활동중 회원 =====
  { id: 'user030', nickname: '은하', grade: '존경 받는 이웃', reportScore: 0, status: '활동중' },
  { id: 'user029', nickname: '별하', grade: '신뢰 깊은 이웃', reportScore: 1, status: '활동중' },
  { id: 'user028', nickname: '노을', grade: '듬직한 이웃', reportScore: 2, status: '활동중' },
  { id: 'user027', nickname: '햇빛', grade: '다정한 이웃', reportScore: 0, status: '활동중' },
  { id: 'user026', nickname: '초롱', grade: '반가운 이웃', reportScore: 1, status: '활동중' },
  { id: 'user025', nickname: '이슬', grade: '조심스러운 이웃', reportScore: 0, status: '활동중' },
  { id: 'user024', nickname: '솔바람', grade: '신뢰 깊은 이웃', reportScore: 2, status: '활동중' },
  { id: 'user023', nickname: '달무리', grade: '존경 받는 이웃', reportScore: 0, status: '활동중' },
  ...
  // ===== 추가 혼합 데이터 =====
  { id: 'user011', nickname: '서리', grade: '존경 받는 이웃', reportScore: 0, status: '활동중' },
  { id: 'user010', nickname: '별빛나래', grade: '신뢰 깊은 이웃', reportScore: 1, status: '활동중' },
  { id: 'user009', nickname: '바위', grade: '듬직한 이웃', reportScore: 4, status: '정지' },
  { id: 'user008', nickname: '모래', grade: '조심스러운 이웃', reportScore: 0, status: '활동중' },
  { id: 'user007', nickname: '풀잎', grade: '반가운 이웃', reportScore: 0, status: '활동중' },
  { id: 'user006', nickname: '별무덤', grade: '조심스러운 이웃', reportScore: 6, status: '탈퇴' },
  { id: 'user005', nickname: '강물', grade: '다정한 이웃', reportScore: 2, status: '활동중' },
  { id: 'user004', nickname: '달그림자', grade: '신뢰 깊은 이웃', reportScore: 5, status: '정지' },
  { id: 'user003', nickname: '숲길', grade: '존경 받는 이웃', reportScore: 0, status: '활동중' },
  { id: 'user002', nickname: '여울', grade: '반가운 이웃', reportScore: 1, status: '활동중' },
